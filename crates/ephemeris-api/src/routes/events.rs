...
pub async fn query_events<E: EventRepository, A: AggregationRepository>(
...
pub async fn get_event<E: EventRepository, A: AggregationRepository>(
    State(state): State<Arc<AppState<E, A>>>,
...
pub async fn capture_event<E: EventRepository, A: AggregationRepository>(
    State(state): State<Arc<AppState<E, A>>>,
